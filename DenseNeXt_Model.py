...
from Enhanced_Inception_Module import EnhancedInceptionModule as Inception, EnhancedInceptionModule
    ...
    def __init__(self, input_data_depth=3, growth_rate=12, dense_block_configuration=(16, 16, 16), compression=0.5,
        ...
        if small_inputs:
            self.layers = nn.Sequential(
                OrderedDict([('initial_inception', EnhancedInceptionModule(input_data_depth=input_data_depth,
